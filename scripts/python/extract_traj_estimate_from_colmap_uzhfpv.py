...
def run():
    ...
    if uzhfpv_flags.camIdxString() == 'left':
        f_img_infos = os.path.join(flags.datasetsPath(), uzhfpv_flags.unzippedGtRelativePath() + '/left_images.txt')
    elif uzhfpv_flags.camIdxString() == 'right':
        f_img_infos = os.path.join(flags.datasetsPath(), uzhfpv_flags.unzippedGtRelativePath() + '/right_images.txt')
    else:
