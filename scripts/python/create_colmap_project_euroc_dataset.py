...
def run(img_folder):
    ...
    colmap_base_dir = os.path.join(flags.datasetsPath(), euroc_flags.colmapBaseDirRelativePath())
    ...
    if euroc_flags.camIdxString() == 'left':
        ...
        assert False, "Please, provide camera index."

    calibs = euroc_util.readCamCalibration(cam_idx)
...
if __name__ == '__main__':
    ...
    img_folder = os.path.join(flags.datasetsPath(), euroc_flags.repoRelPath() + '/img')
